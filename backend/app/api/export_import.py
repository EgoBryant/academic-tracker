...
from app.core.database import get_db  # Твоя зависимость подключения к БД
from app.core.security import get_current_user  # Твоя зависимость авторизации пользователя
